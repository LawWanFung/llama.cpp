...
# Try unSloth version
CMD ["--model", "/app/models/unsloth-gemma-3-12b-it-qat-IQ4_XS.gguf", "--alias","dklm-ai","--mmproj","/app/models/unsloth-mmproj-F16.gguf","--flash-attn","on","-c","32768","--cache-type-k","q8_0","--cache-type-v","q8_0","--context-shift","--temp","1","--host", "0.0.0.0", "--port", "8080"] 
