...
# Try Qwen3
CMD ["--model", "/app/models/Qwen3-14B-Q5_K_M.gguf", "--mmproj","/app/models/llava-phi-3-mini-mmproj-f16.gguf","--flash-attn","on", "-c","128000","--cache-type-k","q8_0","--cache-type-v","q8_0","--context-shift","--temp","1","--host", "0.0.0.0", "--port", "8080"] 
