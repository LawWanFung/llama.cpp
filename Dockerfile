...
CMD ["--model", "/app/models/gpt-oss-120b-Distill-Llama3.1-8B-v2.i1-Q4_K_M.gguf", "--mmproj","/app/models/gpt-oss-120b-Distill-Llama3.1-8B-v2.imatrix.gguf","--flash-attn","on", "-c","128000","--cache-type-k","q8_0","--cache-type-v","q8_0","--context-shift","--jinja","--host", "0.0.0.0", "--port", "8080"] 
