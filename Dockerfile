...
CMD ["--model", "/app/models/gemma-3-12b-it-q4_0.gguf","--model-draft", "/app/models/gemma-3-270m-it-Q8_0.gguf", "--alias","BuddhaViva", "--flash-attn","on","--draft-max","16","--draft-min","4", "-c","8096","--cache-type-k","q8_0","--cache-type-v","q8_0", "--jinja","--host", "0.0.0.0", "--port", "8080"] 
