...
# Try 27B
  CMD ["--model", "/app/models/gemma-3-27b-it-qat-q4_0-gguf:Q4_0","--model-draft", "/app/models/gemma-3-27b-it-qat-q4_0-gguf:Q4_0", "--flash-attn","on","--draft-max","16","--draft-min","4", "--cache-type-k","q8_0","--cache-type-v","q8_0", "--jinja","--host", "0.0.0.0", "--port", "8080"] 
